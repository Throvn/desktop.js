...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "release-3.2.0"
  WORKING_DIRECTORY "/Users/throvn/Documents/desktop.js/build/_deps/sdl_image-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/throvn/Documents/desktop.js/build/_deps/sdl_image-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/throvn/Documents/desktop.js/build/_deps/sdl_image-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
