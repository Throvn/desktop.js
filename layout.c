...
#include "./lib/clay/examples/shared-layouts/clay-video-demo.c"
...
int main(void)
{
    ...
    Font fonts[1];
    fonts[FONT_ID_BODY_16] = LoadFontEx("./lib/clay/examples/raylib-multi-context/resources/Roboto-Regular.ttf", 48, 0, 400);
    ...
    Clay_Context *clayContextTop = Clay_Initialize(clayMemoryTop, (Clay_Dimensions){.width = GetScreenWidth(), .height = GetScreenHeight()}, (Clay_ErrorHandler){HandleClayErrors}); // This final argument is new since the video was published
