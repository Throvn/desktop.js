...
GUI.render(GUI.createElement("group", { "$backgroundColor": "#000000f0" },
    GUI.createElement("hStack", { "$padding": 10 },
        GUI.createElement("group", { "$backgroundColor": "#0000ff6f", "$padding": 10, "$fontSize": 30, onMouseOver: function (event) {
                print("Called mouse over: ", event);
            }, "$color": "tomato" },
            GUI.createElement("text", { onMouseDown: function (event) {
                    print("Called mouse down: ", event);
                }, "$backgroundColor": "#00ff00" }, "About Me"),
